...
if(!size || !cheese || !crust || !sauce){
  ...
  $("#pizza-form").hide();
  result.innerHTML= form.fullName.value + "<br>" + form.phoneNumber.value + "<br>" + form.address.value + "<br><br>" +  size + " Pizza &emsp; $" + sizePrice + ".00 <br>" + cheese + " Cheese &emsp; $" + cheesePrice + ".00 <br>" + crust + " Crust &emsp; $" + crustPrice  + ".00 <br>" + sauce + " Sauce &emsp; $0 <br> Meat Toppings &emsp; $" + meatPrice + ".00 <br> (" + allMeat + ") <br> Veggie Toppings &emsp; $" + veggiePrice + ".00 <br> (" + allVeggies + ") <br> Total &emsp; $" + total + ".00";
